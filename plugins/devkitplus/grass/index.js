/*
 * WASM file source from, and loader code adapted from
 * https://github.com/GooseMod/topaz/blob/main/src/
 * Massive thanks to Ducko for this!
 */

import wasmCode from "./grass.wasm";

let build;
export default (txt, prettified) => build?.(txt, {
	style: prettified ? "expanded" : "",
	quiet: true,
	load_paths: [],
});
