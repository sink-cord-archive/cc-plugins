...
function keyHandler(e) {
	...
	if (e.code === "KeyH" && e.ctrlKey && e.getModifierState("Alt")) {
		...
		if (removeCss === null) removeCss = injectCSS(purifyCss);
		else {
			removeCss();
			removeCss = null;
		}
...
// this object contains the code that tells cumcord how we want to start and stop our plugin
export default {
	// actually assign our keyHandler function to the keyup event
	onLoad: () => document.addEventListener("keyup", keyHandler),
